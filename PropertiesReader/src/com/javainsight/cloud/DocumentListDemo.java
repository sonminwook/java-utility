...
public class DocumentListDemo {
  ...
  public static void main(String[] args)
   ...
   // SimpleCommandLineParser parser = new SimpleCommandLineParser(args);
    String authSub = Constants.AUTH_TOKEN; //parser.getValue("authSub", "auth", "a");
    String user = null ;//Constants.AUTH_TOKEN;//parser.getValue("username", "user", "u");
    
    String password = null ;//parser.getValue("password", "pass", "p");
    String host = Constants.GOOGLE_DOC_URL;//parser.getValue("host", "s");
    boolean help = false; //parser.containsKey("help", "h");
