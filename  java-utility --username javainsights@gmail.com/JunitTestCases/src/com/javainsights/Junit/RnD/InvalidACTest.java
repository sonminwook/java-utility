...
public class InvalidACTest extends TestCase {
	
	private String message = null;
	private Connection connection = null;

	protected void setUp() throws Exception {
		message = PrepareLoginMessage.getLoginHeaderWithInvalidAC() + "," + PrepareLoginMessage.getEmployeeNumber();
