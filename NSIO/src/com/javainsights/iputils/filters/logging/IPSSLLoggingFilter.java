package com.javainsights.iputils.filters.logging;
...
public class IPSSLLoggingFilter extends IoFilterAdapter {
	
	/*
	 * THE LOG
	 */
	private static Logger log = Logger.getLogger(IPSSLLoggingFilter.class);
