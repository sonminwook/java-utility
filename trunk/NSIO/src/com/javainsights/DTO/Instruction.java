...
public class Instruction {
	...
	public String getResponse() {		
		return Common.convertHexToString(response);
	}
	
	/**
	 * This method will give the response in HEX
	 * @return
	 */
...
//	}
	...
	/**
	 * This method needs to be called in case if one wants to use IPCommunication
	 * with terminal. The passed object contains IPConfiguration of terminal.
	 */
	public void setIPConfig(IPConfiguration config){
		this.ipConfig = config;
	}
	
	/**
	 * This method will return the IPConfiguration of terminal.
	 * @return IPConfiguration
	 */
	public IPConfiguration getIPConfig(){
